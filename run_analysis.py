...
ranking_model = SentenceTransformer('./models/all-MiniLM-L6-v2')
...
title_tokenizer = T5Tokenizer.from_pretrained('./models/flan-t5-base')
title_model = T5ForConditionalGeneration.from_pretrained('./models/flan-t5-base')
